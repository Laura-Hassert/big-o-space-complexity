...
// ANSWER: They first function is iterating through the entire alphabet and and adding values to those letters used in the string, whereas the second function is iterating only through the string itself and returning only the letters of the alphabet being used in the string. Both were tested and run with the same string and took the same amount of time.
...
class Challenge {
  ...
  method(num1, num2) {
    if(this.cache.hasOwnProperty(num1, num2)){
      return this.cache[num1, num2]
    } else {
...
const myChallenge = new Challenge

console.time("not memoized function time");
console.log(newMethod(6, 5))
console.log(newMethod(6, 5))
console.log(newMethod(6, 5))
console.log(newMethod(6, 5))
...
console.log(myChallenge.method(6, 5))
console.log(myChallenge.method(6, 5))
console.log(myChallenge.method(6, 5))
console.log(myChallenge.method(6, 5))
